...
DROP POLICY IF EXISTS "Admins can view analytics" ON public.user_subscriptions;
DROP POLICY IF EXISTS "Admins can view scan usage" ON public.scan_usage;
...
-- Grant admin access to view other tables
